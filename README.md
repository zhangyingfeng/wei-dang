...
如果你想归档的其实是**知乎**内容，不是微信公众号，[知档](https://github.com/zhangyingfeng/zhi-dang)更适合你——它更成熟（已经发布到 1.x，长期有真实用户在用），提供登录版（无每日次数限制）和密钥版（走知乎官方开放接口，为上架 Mac App Store 铺路）两种选择，还有完整的图文安装教程。
